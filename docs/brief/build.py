...
open('domain.html','w').write(doc('Your web address, and a simple move',[page(d1),page(d2)]))
...
open('vision.html','w').write(doc('The site, the way you print',[page(v1),page(v2),page(v3),page(v4),page(v5)]))
