...
def cover(funny, docname):
    return f'<section class="page cover"><div class="oval">{OVAL}</div><div class="funny">{funny}</div><div class="est">Est 1985, Ridgway, Colorado</div><div class="rule"></div><div class="doc">{docname}</div><div class="prep">prepared by <b>neonburro</b></div></section>'
...
open('vision.html','w').write(doc('The site, the way you print',[cover('Every job, from the first call to the last box.','The site, the way you print, and twelve questions'),page(v1),page(v2),page(v3),page(v4),page(v5)]))
